...
You can can either go into the Support forum, or in the [WP Recaptcha Integration Repository](https://github.com/mcguffin/wp-recaptcha-integration).
...
Either post it on the [GitHub-repo](https://github.com/mcguffin/wp-recaptcha-integration) or—if you cloned the repository—send me a pull request.
